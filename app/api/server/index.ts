...
import unauthRoutes from "./routes/unauth.js";
...
export async function createServer(
  ...
  /** routesフォルダを元にAPIを生成 */
  app.use("/api", verifyRequest(app), routes);
  app.use("/_unauth/api", unauthRoutes);
...
if (!isTest) {
  createServer().then(({ app }) => {
    console.info(`app started and listening on port ${PORT}.  `, Date());
    app.listen(PORT);
  });
}
